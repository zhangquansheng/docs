...
![thread-pool-executor-constructor](/img/concurrent/thread-pool-executor-constructor)
...
3 | workQueue | BlockingQueue<Runnable> | 当新任务来的时候会先判断当前运行的线程数量是否达到核心线程数，如果达到的话，新任务就会被存放在队列中。
